...
Simulate an enterprise security scan. Enter a corporate domain (e.g., `apple.com`) to instantly retrieve every employee email address flagged as compromised within that infrastructure.
...
- **Observe**: The dashboard instantly aggregates dozens of compromised accounts generated by our seeder, showing the scale of the "simulated dark web" data.
